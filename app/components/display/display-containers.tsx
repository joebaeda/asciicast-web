...
export function DisplayActionsContainer({
  ...
  return (
    <div className="absolute bg-[#17101f] rounded-b-2xl z-20 w-full grid grid-cols-2 items-center gap-1 px-2 py-4 sm:grid-cols-[1fr,auto,1fr]">
...
export function DisplayFooterContainer({
  ...
  return (
    <div className="absolute bottom-0 w-full py-4 bg-[#17101f] rounded-t-2xl z-20 ">
      {children}
    </div>
  );
}
